    ...
    <div class="scrolling-box">
        ...
        <div class=" d-flex justify-content-around pt-7">
            ...
            <div class="col- col-sm- col-md- col-lg- col-xl-2">
                <p class="fts5 mt-4 "><span class="border-bottom border-dark">javascript</span></p>

                <p class="fts5 pt-7 "><a href="projet_javascript.php">Mes projets</a></p>
            </div>
            ...
            <div class="col- col-sm- col-md- col-lg- col-xl-6">
                ...
                <div class="slider-wrapper">
                    <div class="slider-item blueasy">
                        <img src="image/flappy.png" class="img-slider  border border-dark">
                    </div>                   
                </div>
