     ...
     <div class="d-flex justify-content-center text-uppercase font-weight-bold fts3 mb-2 pt-5 title-partie">
        ...
        <div class=" d-flex justify-content-around pt-7">
            ...
            <div class="col- col-sm- col-md- col-lg- col-xl-2">
                <p class="fts5 mt-4 "><span class="border-bottom border-dark">php</span></p>

                <p class="fts5 pt-7 "><a href="{{ path('projet_php') }}">Mes projets</a></p>
            </div>
            ...
            <div class="col- col-sm- col-md- col-lg- col-xl-6">
                ...
                <div class="slider-wrapper">
                    <div class="slider-item blueasy">
                        <img src="image/assuretout.jpg" class="img-slider  border border-dark">
                    </div>
                    <div class="slider-item snow">
                        <img src="image/tchat.jpg" class="img-slider  border border-dark">
                    </div>
                    <div class="slider-item burger">
                        <img src="image/formulaire.jpg" class="img-slider  border border-dark">
                    </div>
